...
return [
    ...
    'models' => [
        ...
        'hostname' => \Xpsaas\Tenancy\Models\Hostname::class,

        // Must implement \Hyn\Tenancy\Contracts\Website
        'website' => \Xpsaas\Tenancy\Models\Website::class
    ],
    /**
...
//        \Xpsaas\Tenancy\Middleware\EagerIdentification::class,
//
//        // The hostname actions middleware (redirects, https, maintenance).
//        \Xpsaas\Tenancy\Middleware\HostnameActions::class,
//    ],
    'website' => [
        /**
         ...
         */
        'random-id-generator' => Xpsaas\Tenancy\Generators\Uuid\ShaGenerator::class,
    ...
    'db' => [
         ...
         */
        'password-generator' => Xpsaas\Tenancy\Generators\Database\DefaultPasswordGenerator::class,
